    ...
    <div className="w-full h-auto bg-black pt-10 ps-10 flex flex-col justify-between">
      <div>
        ...
        <div className="grid grid-cols-3 my-5">
          ...
          <div>
           <ul>
              <li className="nav-link flex items-center gap-2"><CgProfile className="text-white" />KISHORE E</li>
              <li className="nav-link">22ITR047</li>
              <li className="nav-link">9344735711</li>
